...
BUCKET_NAME = "taxi-rides-ny-19-20"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = "/home/david/.ssh/project-a44b4f29-ed58-4b15-810-15282952039f.json"
...
def download_file(year, month):
    ...
    file_path = os.path.join(DOWNLOAD_DIR, f"fhv_tripdata_{year}-{month}.csv.gz")
...
if __name__ == "__main__":
    ...
    with ThreadPoolExecutor(max_workers=4) as executor:
        futures = [executor.submit(download_file, y, m)
                for y, m in jobs]
